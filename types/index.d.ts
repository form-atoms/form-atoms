 ...
 */
export declare function Form<Fields extends FormAtomFields>(
 ...
 */
export declare function InputField<Value extends string | number | string[]>(
 ...
 *   a unique symbol. The primary use case of scope is for library usage.
 */
export declare function useFieldAtomInitialValue<Value>(
  fieldAtom: FieldAtom<Value>,
  initialValue?: Value,
  scope?: Scope
): void;
 ...
 */
export declare type ValidateConfig<Value> = Parameters<
